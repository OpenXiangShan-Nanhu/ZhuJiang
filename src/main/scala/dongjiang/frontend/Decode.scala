...
class Decode(implicit p: Parameters) extends DJModule {
  ...
  val validReg_s3       = RegNext(io.task_s2.valid, false.B) // TODO
   ...
   */
  val cleanUnuseDB_s3               = validReg_s3 & taskReg_s3.alr.reqDB & !taskReg_s3.chi.isFullSize & !(respDir_s3.sf.hit | respDir_s3.llc.hit) // TODO
